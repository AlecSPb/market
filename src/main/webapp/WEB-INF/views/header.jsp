...
<header class="header__wrapper">
  ...
  &lt;%&ndash;  <div class="header__contacts">
    ...
    <c:if test="${pageContext.request.userPrincipal.role!=('ROLE_USER';null)}">
    <nav class="header__menu">
        <form id="admin" method="get" action="${contextPath}/admin"></form>
        <input type="hidden" name="${_csrf.parameterRole}" value="${_csrf.token}"/>
        </form>
        <ul class="menu__wrapper">
            ...
            <li>
                <a class="link link_header" onclick="document.forms['admin'].submit()">Admin</a>
            </li>
        </ul>
    </nav>
    </c:if>
    <c:if test="${pageContext.request.userPrincipal.role!='ROLE_ADMIN'}">
    <nav class="header__menu">
        <ul class="menu__wrapper">
            <li>
                <a href="${contextPath}/home" class="link link_header">Home</a>
