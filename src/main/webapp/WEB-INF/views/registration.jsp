        ...
        <div class="row">
            ...
            <div class="checkout_details_area mt-50 clearfix">
              ...
              <form method="POST" modelattribute="customer">
                <div class="row">
                  ...
                  <input type="text" class="form-control mb-3" name="parole" id="parole" placeholder="Password*" value="" draggable="true">
                  <input type="text" class="form-control mb-3" name="transientparole" id="transientparole" placeholder="Password*" value="" draggable="true"> </div>
                <button type="submit" class="btn amado-btn mb-15 disabled">Login</button>
              </form>
            </div>
          ...
          <div class="col-12 col-lg-4">
            <h1 class="">
              ...
              <br>&nbsp;</h1>
            <a class="btn amado-btn mb-15" href="registration.jsp">Register</a>
          </div>
        </div>
      </div>
    </div>
